...
# plot qSIP output against manual output
ggplot(mw_001, aes(mw_manual, mw_qsip)) +
  geom_abline(aes(slope=1, intercept=0), color=hsv(0, 1, .8)) +
  geom_point(color=hsv(.55, 1, .4)) +
  xlab('Manual calculation') +
  ylab('qSIP package') +
...
# plot qSIP output against manual output
ggplot(mw_010, aes(mw_manual, mw_qsip)) +
  geom_abline(aes(slope=1, intercept=0), color=hsv(0, 1, .8)) +
  geom_point(color=hsv(.55, 1, .4)) +
  xlab('Manual calculation') +
  ylab('qSIP package') +
...
# plot qSIP output against manual output
ggplot(mw_011, aes(mw_manual, mw_qsip)) +
  geom_abline(aes(slope=1, intercept=0), color=hsv(0, 1, .8)) +
  geom_point(color=hsv(.55, 1, .4)) +
  xlab('Manual calculation') +
  ylab('qSIP package') +
...
# plot qSIP output against manual output
ggplot(mw_100, aes(mw_manual, mw_qsip)) +
  geom_abline(aes(slope=1, intercept=0), color=hsv(0, 1, .8)) +
  geom_point(color=hsv(.55, 1, .4)) +
  xlab('Manual calculation') +
  ylab('qSIP package') +
...
# plot qSIP output against manual output
ggplot(mw_101, aes(mw_manual, mw_qsip)) +
  geom_abline(aes(slope=1, intercept=0), color=hsv(0, 1, .8)) +
  geom_point(color=hsv(.55, 1, .4)) +
  xlab('Manual calculation') +
  ylab('qSIP package') +
...
# plot qSIP output against manual output
ggplot(mw_110, aes(mw_manual, mw_qsip)) +
  geom_abline(aes(slope=1, intercept=0), color=hsv(0, 1, .8)) +
  geom_point(color=hsv(.55, 1, .4)) +
  xlab('Manual calculation') +
  ylab('qSIP package') +
...
# plot qSIP output against manual output
ggplot(mw_111, aes(mw_manual, mw_qsip)) +
  geom_abline(aes(slope=1, intercept=0), color=hsv(0, 1, .8)) +
  geom_point(color=hsv(.55, 1, .4)) +
  xlab('Manual calculation') +
  ylab('qSIP package') +
...
# plot qSIP output against manual output
ggplot(ae_000, aes(excess_manual, excess_qsip)) +
  geom_abline(aes(slope=1, intercept=0), color=hsv(0, 1, .8)) +
  geom_point(color=hsv(.55, 1, .4)) +
  xlab('Manual calculation') +
  ylab('qSIP package') +
  ...
  ylim(min(c(ae_000$excess_manual, ae_000$excess_qsip)), 
       max(c(ae_000$excess_manual, ae_000$excess_qsip))) +
  labs(title='Comparison of atom excess values', 
       subtitle='Calculation code: 000')
```
...
# plot qSIP output against manual output
ggplot(ae_001, aes(excess_manual, excess_qsip)) +
  geom_abline(aes(slope=1, intercept=0), color=hsv(0, 1, .8)) +
  geom_point(color=hsv(.55, 1, .4)) +
  xlab('Manual calculation') +
  ylab('qSIP package') +
...
# plot qSIP output against manual output
ggplot(ae_010, aes(excess_manual, excess_qsip)) +
  geom_abline(aes(slope=1, intercept=0), color=hsv(0, 1, .8)) +
  geom_point(color=hsv(.55, 1, .4)) +
  xlab('Manual calculation') +
  ylab('qSIP package') +
...
# plot qSIP output against manual output
ggplot(ae_011, aes(excess_manual, excess_qsip)) +
  geom_abline(aes(slope=1, intercept=0), color=hsv(0, 1, .8)) +
  geom_point(color=hsv(.55, 1, .4)) +
  xlab('Manual calculation') +
  ylab('qSIP package') +
