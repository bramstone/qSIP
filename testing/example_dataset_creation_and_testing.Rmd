...
# average heavy MWs by OTU and group
aeh <- aggregate(mw_manual ~ OTU + group, aeh, mean, na.rm=T)
...
# average light MWs by OTU and group
ael <- aggregate(mw_manual ~ OTU + group, ael, mean, na.rm=T)
