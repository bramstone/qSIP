...
mdq <- calc_excess(mdq, separate_label=F, separate_light=T)
...
# manual calculation-------------------------------------------
ae <- mw_001[,!names(mw_001) %in% 'mw_qsip']

# separate MW-light and MW-label
aeh <- ae[ae$tmt=='18O',]
ael <- ae[ae$tmt=='16O',]

# DON'T average heavy MWs, they've already been calculated based on averages

# calculate MW-heavymax
adjust <- 12.07747
nat_abund <- 0.002001429
